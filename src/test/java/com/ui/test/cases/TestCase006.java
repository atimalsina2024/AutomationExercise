...
import com.ui.test.helper.ContactUsFlow;
...
//		11. Click 'Home' button and verify that landed to home page successfully
		...
		contactUsFlow.fillOutFeedback(config.getProperty("name"),config.getProperty("email"), config.getProperty("feedback.message"),config.getProperty("account.registration.data") );
