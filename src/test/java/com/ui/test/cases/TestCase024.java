...
//	22. Verify 'ACCOUNT DELETED!' and click 'Continue' button
	@Test(description = "Test Case 24: Download Invoice after purchase order", groups = {"functional", "regression", "positive"})
	public void TC_024_Download_Invoice_After_Purchase_Order() {
		...
		cartPageFlow.proceedToCheckout();
		cartPageFlow.addMessageAndPlaceOrder(config.getProperty("order.message"));
